...
function downloadInstallerOnly(e) {
    ...
    a.href = primaryURL;
    a.download = 'SahayakGuru_OnlineInstaller.exe';
...
(function () {
    ...
    if (emailBtn) emailBtn.addEventListener('click', () => {
        window.location.href = 'mailto:info@sahayakguru.store?subject=HEWP%20Excel%20Addins%20Support&body=Hello%20MRGARGSIR%20Team,%0D%0A%0D%0AI%20need%20help%20with...';
    });
    if (whatsappBtn) whatsappBtn.addEventListener('click', () => {
        window.open('https://wa.me/919728532828?text=' + encodeURIComponent("Hello MRGARGSIR Team, I need help with Sahayak Guru Tool."), '_blank');
    });
})();
...
function startDownload(button) {
    ...
    if (button.id === 'downloadBtnStandalone') {
        downloadURL = standaloneURL; secondURL = fallbackURL; installerName = 'SahayakGuru_OfflineInstaller.exe';
    } else {
        downloadURL = primaryURL; secondURL = fallbackURL; installerName = 'SahayakGuru_OnlineInstaller.exe';
    }
        ...
        <div class="ticker-bar ticker-bar-global" style="flex-basis:100%; order:2; width:100%;">
            <div class="ticker-wrap">
                <div class="ticker-track">
                    <span class="ticker-item">🚀 Sahayak Guru Tool • BOQ • Estimate • Variation • MB</span>
